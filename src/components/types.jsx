export const getBackgroundColor = (type) => {
  const typeStyles = {
    ...
    grass: {
      ...
      textClass: "text-[#38ef7d]",
      borderClass: "border-[#38ef7d]",
      gradientClass: "from-[#ab2f] to-[#38ef7d]",
    },
    bug: {
      backgroundClass: "bg-lime-500",
      textClass: "text-[#a8e063]",
      borderClass: "border-[#a8e063]",
      gradientClass: "from-[#56ab2f] to-[#a8e063]",
    },
    electric: {
      backgroundClass: "bg-yellow-300",
      textClass: "text-[#fffea3]",
      borderClass: "border-[#fffea3]",
